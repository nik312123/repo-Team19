...
final class VotingStreamParserTest {
    ...
    void testParseMultipleIrFiles() {
        ...
        try {
            FileInputStream inputStream1 = new FileInputStream(inputPath1);
            FileInputStream inputStream2 = new FileInputStream(inputPath2);
            FileInputStream inputStream3 = new FileInputStream(inputPath3);
            
            final InstantRunoffSystem instantRunoffSystem = (InstantRunoffSystem) Assertions.assertDoesNotThrow(() ->
                VotingStreamParser.parse(new InputStream[] {inputStream1, inputStream2, inputStream3}, new String[] {inputPath1, inputPath2,
                    inputPath3}, NULL_OUTPUT, NULL_OUTPUT, HEADER_SYSTEM_MAP));
            
            List<Candidate> expectedCandidates = List.of(
                new Candidate("Rosen", "D"),
                new Candidate("Kleinberg", "R"),
                new Candidate("Chou", "I"),
                new Candidate("Royce", "L"));
